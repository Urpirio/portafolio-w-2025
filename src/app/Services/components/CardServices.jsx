...
export default function CardServices(props) {
  ...
  return (
   <article className=' h-100 w-[25%] min-w-80 flex flex-col items-center justify-center gap-5 p-5 border-1 border-gray-300 rounded-3xl bg-gray-50 shadow-xl'>
    ...
    <div className='w-[100%] flex justify-center '>
        <button className='h-10 w-[100%] border-1 rounded-2xl text-white bg-green-500'>Get service</button>
    </div>
   </article>
  )
}
