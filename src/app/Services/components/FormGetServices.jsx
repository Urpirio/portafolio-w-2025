    ...
    <div onClick={OffSelectServices}  className='hidden flex-col items-center justify-center backdrop-blur-xs shadow-2xl absolute  h-[100%] w-[100%] ' id='FormGetServices'>
          <form onMouseEnter={MouseOverSelectServices} onMouseLeave={MouseOverSelectServices} onSubmit={(e)=>{SendForm(e)}}  action="" className='flex flex-col gap-5  border-3 rounded-2xl bg-white border-green-500 p-5 min-w-80 w-[25%] '>
            ...
            <div className='flex flex-col'>
              ...
              <input className='border-1 border-gray-400 rounded-md outline-none h-10 p-2 ' type="text" name="" id="NameF" placeholder='Your name'/>
            </div>
            <div className='flex flex-col'>
              <label htmlFor="">Email</label>
              <input className='border-1 border-gray-400 rounded-md outline-none h-10 p-2' type="text" name="" id="EmailF" placeholder='Your Email' />
            </div>
            <div className='flex flex-col'>
              <label htmlFor="">Phone number</label>
              <input className='border-1 border-gray-400 rounded-md outline-none h-10 p-2' type="text" name="" id="PnumberF" placeholder='Your phone number'/>
            </div>
            <div className='flex flex-col'>
              <label htmlFor="">Company</label>
              <input className='border-1 border-gray-400 rounded-md outline-none h-10 p-2' type="text" name="" id="CompanyF" placeholder='Name of your company'/>
            </div>
            ...
            <div className='flex flex-col'>
              ...
              <textarea className='border-1 border-gray-400 rounded-md outline-none p-2 resize-none' name="" id="AboutProyect" placeholder='Tell me about your proyect...'></textarea>
            </div>
