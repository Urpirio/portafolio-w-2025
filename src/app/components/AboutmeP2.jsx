...
export default function AboutmeP2() {
  ...
  return (
    <section className='flex flex-wrap justify-center p-10 gap-20'>
        <div className='flex flex-col gap-2 p-5 min-w-100 w-[40%] max-w-180'>
            <div>
                <h2 className='font-bold text-2xl m-0'>Get to Know me!</h2>
            </div>
            <div>
                <p className='text-[16px] pb-2 pt-2'>I'm a Frontend Focused Web Developer building and managing
                ...
                <p className='text-[16px] pb-2 pt-2'>
        ...
        <div className=' flex flex-col items-center min-w-100 w-[40%] max-w-180  p-5 gap-[22]'>
            <div className='w-[100%]'>
