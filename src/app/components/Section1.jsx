...
export default function Section1() {
  ...
  return (
    ...
    <div className='flex flex-col items-center w-[100%] gap-2'>
      ...
      <p className=' text-xl sm:text-2xl text-gray-600 text-center'>A results-driven Mobile Developer and Web
      focused on building and optimizing websites and web applications,Mobile application to enhance user experience and drive product success.</p>
    </div>
