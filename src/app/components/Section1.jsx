...
export default function Section1() {
  ...
  return (
    <section className=' flex flex-col  items-start  gap-10 p-20 bg-white  relative z-0'>
        <div className='absolute flex flex-col rounded-2xl border-gray-300 border-1 gap-2 p-1 bg-white shadow-2xl shadow-green-100 '>
    ...
    <div className='w-[100%] flex justify-center items-center'>
        <Image src={PerfilDev} className='h-80 w-80 rounded-[100%] '/>
    </div>
    <div className='flex flex-col items-center gap-2'>
      <h1 className=' font-extrabold text-5xl'>Hey, I'm  Urpirio Junior</h1>
      <span className=' text-2xl text-center text-gray-600'>A Result-Oriented Web Developer building and managing
