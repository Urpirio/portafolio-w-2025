  ...
  return (
    <article className='flex flex-col gap-2 shadow-xl border-2 border-gray-300 rounded-xl ' id={props.id}>
        ...
        <div className='w-[100%]  p-2 flex justify-center gap-2'>
            ...
            <button onClick={()=>{LinkGithud(props.LinkGithud)}} className='flex justify-center items-center h-10 w-[15%] border-1 rounded-xl bg-gray-900 text-white shadow-2xs cursor-pointer text-2xl transition-all duration-200 hover:opacity-75'><i class='bx bxl-github'></i></button>
        </div>
    </article>
  )
}
